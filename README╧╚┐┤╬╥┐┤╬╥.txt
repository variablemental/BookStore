...
四、数据库课程设计报告(基于JSP+HTML网页的书店管理系统)有两个版本：
	docx 的 word 版本为 OFFICE WORD 2016建立，
		使用 office word 2016以下版本
		或者WPS程序
		以及其他开源office软件打开可能会出现一些排版问题。
	
	pdf 版为 word 版本转换而成，里面的目录可以点击达到导航的目的

!!推荐查看数据库课程设计报告 PDF 版的电子版本。
